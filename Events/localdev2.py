...
try:
    ...
    def getTaskSummary(taskSummaryObj):
        taskSummaryData={}
    ...
    def getTotalExternalEvents(taskId, tenant):
        externalEventsUrl = ('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/' + tenant + '/api/eventservice/get')
    ...
    def getTotalManageEvents(taskId, tenant):
        manageEventsUrl = ('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/' + tenant + '/api/eventservice/get')
    ...
    def getTotalGovernEvents(taskId, tenant):
        governEventsUrl = ('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/' + tenant + '/api/eventservice/get')
    ...
    def getTotalRequestObjects(taskId, tenant):
        requestObjectUrl = ('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/' + tenant + '/api/requesttrackingservice/get')
    ...
    measurement_name = 'integration_report'
    ...
    tenantGetUrl = ('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/dataplatform/api/configurationservice/get')
    ...
    for t in tenants:
        ...
        taskSummaryUrl=('http://manage.engg-az-qa7.riversand-dataplatform.com:8085/'+ str(t) +'/api/requesttrackingservice/get')
        ...
        if not importTaskSummaryQueryResponse.json()['response']['totalRecords']==0:
            ...
            for i in range(totalImportTaskSummary):
                importTaskSummary = getTaskSummary(importTaskSummaryQueryResponse.json()['response']['requestObjects'][i]['data']['attributes'])
        ...
        if not exportTaskSummaryQueryResponse.json()['response']['totalRecords'] == 0:
            ...
            for k in range(totalExportTaskSummary):
                exportTaskSummary = getTaskSummary(exportTaskSummaryQueryResponse.json()['response']['requestObjects'][k]['data']['attributes'])
